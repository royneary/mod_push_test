...
public class GcmSender {
    ...
    public static final String API_KEY = "AIzaSyDowGvYWTG4DBGSjwbXs8EONfSf-4CuDF8";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (args.length > 1 && args[1] != null) {
                jData.put("last_message_sender", "GcmSender");
                jData.put("message_count", 1);
                jData.put("pending_subscription_count", 42);
                jData.put("last_message_body", args[0].trim());
            ...
            System.out.println("sending json: " + jGcmData.toString());
